namespace ngfx {
    ...
    enum StencilOperation {
        ...
        IncrementAndClamp   [[vk("VK_STENCIL_OP_INCREMENT_AND_CLAMP"),  mtl("MTLStencilOperationIncrementClamp")]],
        DecrementAndClamp   [[vk("VK_STENCIL_OP_DECREMENT_AND_CLAMP"),  mtl("MTLStencilOperationDecrementClamp")]],

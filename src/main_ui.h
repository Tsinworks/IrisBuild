...
#define UI_COMBO_SEL(_class, _slot)                                                                \
  static void ZUI_COMBO_##_slot(uiCombobox* combo, void* data) {                                   \
    _class* ptr = (_class*)data;                                                                   \
    ptr->on_sel_##_slot(combo);                                                                    \
  }                                                                                                \
  void on_sel_##_slot(uiCombobox* combo)

#define UI_COMBO_BIND(_class, _slot, _combo)                                                       \
  uiComboboxOnSelected(_combo, &_class::ZUI_COMBO_##_slot, this)
...
namespace iris {
	...
	namespace ui {
		...
		private:
			...
			void generate_platform_selector();

			UI_COMBO_SEL(main_ui, platform);

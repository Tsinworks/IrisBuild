...
namespace iris
{
    ...
    public:
        ...
        virtual int         create_process(wstring const&app_name, wstring const& cmd) x_func(rpc) = 0;
    ...
    public:
        ...
        int         create_process(wstring const&app_name, wstring const& cmd) override;
    ...
    class virtual_process_server : public virtual_process
    {
    public:

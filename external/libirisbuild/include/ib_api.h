...
IBVM_API const char* iris_value_get_string(iris_value_t value);
IBVM_API iris_value_type iris_value_get_type(iris_value_t value);
// scope
IBVM_API iris_scope_t iris_scope_new(iris_scope_t parent);
IBVM_API void iris_scope_free(iris_scope_t scope);
IBVM_API iris_value_t iris_scope_get_value(iris_scope_t scope, const char* ident);
...
IBVM_API int iris_value_list_size(iris_value_list_t args);
IBVM_API iris_value_type iris_value_list_get_type(iris_value_list_t args, int arg_no);
IBVM_API const char* iris_value_list_get_string(iris_value_list_t args, int arg_no);
